  ...
  <form action="" method="post" class="pad-10">
    <div class="row d-flex">
      <div class="inputs flex pad-5 p-rel">
        ...
        <input name="Name" type="text" placeholder="<?= $text_label_Name ?>" value="<?= $supplier->Name?>">
        <span class="p-abs bottom-0 left-0 trans"></span>
      </div>
      <div class="inputs flex pad-5 p-rel">
        <label for=""><?= $text_label_PhoneNumber ?></label>
        <input name="PhoneNumber" type="text" placeholder="<?= $text_label_PhoneNumber ?>" value="<?= $supplier->PhoneNumber?>">
        <span class="p-abs bottom-0 left-0 trans"></span>
      </div>
      <div class="inputs flex pad-5 p-rel">
        <label for=""><?= $text_label_Email ?></label>
        <input name="Email" type="email" placeholder="<?= $text_label_Email ?>" value="<?= $supplier->Email?>">
        <span class="p-abs bottom-0 left-0 trans"></span>
      </div>
      <div class="inputs flex pad-5 p-rel">
        <label for=""><?= $text_label_Address ?></label>
        <input name="Address" type="text" placeholder="<?= $text_label_Address ?>" value="<?= $supplier->Address?>">
        <span class="p-abs bottom-0 left-0 trans"></span>
      </div>
    </div>
