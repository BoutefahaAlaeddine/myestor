<div class="sidebar p-rel trans">
  ...
  <ul class="links t-trn-cp">
    ...
    <li class="trans">
      ...
      <ul class="sub-links t-trn-cp  o-hidden trans">
        <li class="trans">
          <a class="c-white d-block" href="<?= MAIN_LINK . "productCategory" ?>">
            <i class="fa-solid fa-layer-group"></i> 
            <span><?= $text_store_categories ?></span>
          </a>
        </li>
        <li class="trans">
          <a class="c-white d-block" href="<?= MAIN_LINK . "product" ?>">
          <i class="fa-solid fa-basket-shopping"></i>            
          <span><?= $text_store_products ?></span>
          </a>
        </li>
      </ul>
    </li>
